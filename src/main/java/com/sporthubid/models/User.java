...
public class User implements Serializable {
    ...
    public String toString() {
        return "User{" + "username='" + username + '\'' + '\'' + ", name='" + f_nama + " " + l_nama + '\''
                + ", email='" + email + '\'' + ", alamat='" + alamat + ", No HP='" + no_hp + '\'' + ", Tempat Lahir='" + tmp_lahir + ", Tanggal Lahir='" + tgl_lahir + ", jenis_kelamin='" + jenis_kelamin + '\'' + ", Minat Olahraga='" + minat_or + '}';
    }
}
